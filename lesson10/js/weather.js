...
const apiURL = "//api.openweathermap.org/data/2.5/forecast?id=5604473&appid=70a4a7a5754f3ab4edd8b99f5c1ebcb8&units=imperial";
...
const newapiURL = "//api.openweathermap.org/data/2.5/weather?id=5604473&appid=70a4a7a5754f3ab4edd8b99f5c1ebcb8&units=imperial";
fetch(newapiURL)
  .then((response) => response.json())
  .then((weatherInfo) => {
